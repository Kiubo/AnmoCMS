...
<title><?= $config['hotelName'] ?> : Administración</title>
...
<a class="navbar-brand" href="javascript:;">Nutella ACP <b>></b> Dashboard</a><?php Version(); ?>
</div>
...
<p class="card-category">Usuarios Regstrados</p>
<h3 class="card-title"><?= Game::regCount(); ?>
</h3>
</div>
...
<p class="card-category">Usuario Staff Online</p>
<h3 class="card-title"><?= Game::staffCount(); ?></h3>
</div>
<div class="card-footer">
</div>
</div>
...
<p class="card-category">Usuarios Onlines</p>
<h3 class="card-title"><?= Game::usersOnline(); ?></h3>
</div>
<div class="card-footer">
</div>
</div>
...
<h3 class="card-title"><?= Game::bansCount(); ?></h3>
</div>
<div class="card-footer">
</div>
</div>
...
<span class="nav-tabs-title">Changelog's</span>
...
<i class="material-icons">code</i> CMS
<div class="ripple-container"></div>
</a>
</li>
<li class="nav-item">
<a class="nav-link" href="#settings" data-toggle="tab">
<i class="material-icons">cloud</i> EMULADOR
<div class="ripple-container"></div>
</a>
</li>
</ul>
...
<h4 class="card-title">Usuarios con rangos</h4>
<p class="card-category">El equipo completo del hotel</p>
</div>
...
?>
<?php
$getArticles = $dbh->prepare("SELECT * FROM ranks WHERE id >= '3' ORDER BY id DESC");
$getArticles->execute();
while($news = $getArticles->fetch())
{ ?>
<?php 
$Getusers = $dbh->prepare("SELECT * FROM users WHERE rank = '". $news['id'] ."' LIMIT 5");
$Getusers->execute();
