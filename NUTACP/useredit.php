...
<title>Administración > Usuarios > Editar Usuario</title>
...
<a class="navbar-brand" href="javascript:;">Nutella ACP <b>></b> Usuarios</a>
</div>
...
<h4 class="card-title">Editar usuario : <?php echo admin::EditUser("username"); ?></h4>
<p class="card-category">Recuerda que debes tener cuidado con lo que editas</p>
</div>
<div class="card-body">
...
<br><br>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Correo del usuario</label>
<div class="col-sm-10">
...
<br><br>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Mision del usuario</label>
<div class="col-sm-10">
...
<br><br>
<div class="form-group">
<label class="col-sm-2 col-sm-3 control-label">Creditos del usuario</label>
<div class="col-sm-10">
...
<br><br>
<div class="form-group">
<label class="col-sm-2 col-sm-3 control-label">Duckets del usuario</label>
<div class="col-sm-10">
...
<br><br>
<div class="form-group">
<label class="col-sm-2 col-sm-5 control-label">Diamantes del usuario</label>
<div class="col-sm-10">
