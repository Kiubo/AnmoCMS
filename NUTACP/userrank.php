...
<p class="card-category">Buscar usuario para dar rango</p>
</div>
<div class="card-body">
...
<label class="col-sm-2 col-sm-5 control-label">Nombre del Usuario</label>
<div class="col-sm-10">
<input type="text"  value="" name="user" class="form-control">
</div>
</div>
<br><br>
<button name="zoek" type="submit" class="btn btn-success">Buscar Usuario</button>
</div>
</section>
</div>
</form>
