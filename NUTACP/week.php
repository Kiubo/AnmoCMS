...
<p class="lead"><span class="badge info-color p-2"><?= $lang["HkWeekUser"] ?></span></p>
<div class="col-md-6">
<input type="text" class="form-control" id="input-text" name="user" placeholder="Usuario a dar el rango" value="<?php echo $info['username']; ?>" style="width:213%;">
</div>
<input name="zoek" type="submit" class="btn btn-dark bg-blue-grey-800 color-white margin-left-10" value="Buscar">
</form>
