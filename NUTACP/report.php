...
<title>Administración > Reportes</title>
...
<a class="navbar-brand" href="javascript:;">Nutella ACP <b>></b> Reportes</a>
</div>
...
<h4 class="card-title">Reportes de los usuarios</h4>
...
<th class="th-lg"><a>Titulo <i class="fa fa-sort ml-1"></i></a></th>
<th class="th-lg"><a>Categoria<i class="fa fa-sort ml-1"></i></a></th>
<th class="th-lg"><a>Comentario<i class="fa fa-sort ml-1"></i></a></th>
<th class="th-lg"><a>Usuario<i class="fa fa-sort ml-1"></i></a></th>
<th class="th-lg"><a>Eliminar<i class="fa fa-sort ml-1"></i></a></th>
</tr>
</thead>
<tbody>
<?php
$getArticles = $dbh->prepare("SELECT * FROM nutella_report ORDER BY id DESC");
$getArticles->execute();
