...
<title>Administración > Usuarios > Usuario de la Semana</title>
...
<a class="navbar-brand" href="javascript:;">Nutella ACP <b>></b> Usuarios <b>></b> Usuario de la semana</a>
</div>
...
<h4 class="card-title">Usuario de la semana : <?php echo admin::EditUserOfTheWeek("username"); ?></h4>
<p class="card-category">Buscar usuario para posicionar en Usuario de la semana</p>
</div>
<div class="card-body">
...
<input type="hidden" id="f1" class="form-control" value="<?php echo admin::EditUserOfTheWeek("username"); ?>" name="naam">
<label for="f1" class=""><?php echo admin::EditUserOfTheWeek("username"); ?></label>
</div>
</div>
...
<div class="md-form form-sm">
<input type="hidden" id="f2" class="form-control" value="<?php echo admin::EditUserOfTheWeek("motto"); ?>" name="motto">
<label for="f2" class=""><?php echo admin::EditUserOfTheWeek("motto"); ?></label>
</div>
...
<div class="md-form form-sm">
<input type="text" id="f3" class="form-control" value="" name="uftwtext">
<label for="f3" class="disabled"><?= $lang["HkWeekRazon"] ?></label>
</div>
...
<button name="update" type="submit" class="btn btn-success waves-effect waves-light" style="width:100%;">Posicionar como Habbo de la Semana</button>
</form>
